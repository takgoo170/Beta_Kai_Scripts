...
Blog = Window:AddTab({ Title = "Fruits/Raids", Icon = "cherry" })
Island = Window:AddTab({ Title = "Islands", Icon = "tree-palm" })
Stack = Window:AddTab({ Title = "Quest", Icon = "swords" })
Sea = Window:AddTab({ Title = "Sea Events", Icon = "sailboat" })
Race = Window:AddTab({ Title = "Race V4", Icon = "cog" })
Get = Window:AddTab({ Title = "Items", Icon = "box" })
Teleport = Window:AddTab({ Title = "Teleport", Icon = "locate" })
-- Quest = Window:AddTab({ Title = "Quests", Icon = "swords" })
ChooseSkill = Window:AddTab({ Title = "Skills Settings", Icon = "settings-2" })
ESP = Window:AddTab({ Title = "ESP", Icon = "database" })
...
Toggle = Teleport:AddToggle("Toggle", {Title = "Teleport Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Settings:AddToggle("Bypass TP", { Title = "Stop Teleport", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Settings:AddToggle("Toggle", {Title = "Reduce Lag", Description = "To improve stability in-game.", Default = true })
Toggle:OnChanged(function(Value)
...
------- MAIN FARM TAB -------
Main:AddSection("DISCORD SERVER")
Main:AddButton({
...
Toggle = Main:AddToggle("Toggle", { Title = "Start Auto Farm", Description = "Start auto farming based on your Farm Method.",Default = false })
Toggle:OnChanged(function(Value)
    getgenv().AutoFarm = Value
    StopTween(getgenv().AutoFarm)
end)
if World1 then
Toggle = Main:AddToggle("Toggle", {Title = "Auto Second Sea", Default = false })
Toggle:OnChanged(function(Value)
...
if World2 then
Toggle = Main:AddToggle("Toggle", {Title = "Auto Third Sea", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Main:AddToggle("Toggle", {Title = "Farm Material", Description = "Start farming materials.", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Main:AddToggle("Toggle", {Title = "Auto Kill Boss", Description = "Auto Kill Selected Boss", Default = getgenv().AutoFarmBoss })
Toggle:OnChanged(function(Value)
...
Toggle = Main:AddToggle("Toggle", {Title = "Auto Kill All Bosses", Description = "Auto Kill All Bosses spawned", Default = false })
Toggle:OnChanged(function(Value)    
...
Dropdown = Main:AddDropdown("DropdownFarm", {
    Title = "Select Farm Mastery Method",
...
Toggle = Main:AddToggle("Toggle", { Title = "Auto Farm Mastery", Description = "Starts auto farming mastery", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", { Title = "Auto Buy Melee", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {Title = "Auto Elite Hunter", Description = "If you want to see your elite status go to Status tab!", Default = false })
Toggle:OnChanged(function(Value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Toggle = Stack:AddToggle("Toggle", { Title = "Auto Summon Cake Prince", Description = "When you killed 500 monsters, you will automatically summon Cake Prince", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {Title = "Auto Quest Dojo Trainer", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {Title = "Auto Upgrade Dragon Talon", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {Title = "Auto Farm Blaze Ember", Description = "Kills Hydra Mob and Collect Blaze Ember", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {Title = "Auto Collect FireFlower", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Other:AddToggle("Toggle", {Title = "Auto Stop [ if Chalice & Fist owned ]", Default = false })
Toggle:OnChanged(function(Value)
    getgenv().StopChest = Value
end)
spawn(function()
...
Toggle = Other:AddToggle("Toggle", {Title = "Auto Observation V2", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Blog:AddToggle("Toggle", {Title = "Teleport To Fruit", Default = false })
Toggle:OnChanged(function(Value)
...
zoneselect = Sea:AddDropdown("zoneselect", {
	...
	Description = "Select the danger level zone that you will travel.",
	Values = ListSeaZone,
	Multi = false,
	Default = false,
})
...
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Sea Event", Description = "Start Farming Sea", Default = false })
...
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Kill Shark",Default = false })
Toggle:OnChanged(function(value)
   getgenv().AutoKillShark = value
   StopTween(getgenv().AutoKillShark)
end)
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Kill Piranha",Default = false })
Toggle:OnChanged(function(value)
...
Slider = Sea:AddSlider("Slider", {
     Title = "Azure Ember Amount",
     Description = "Select the amount of Azure to trade.",
     Default = 20,
     Min = 0,
     Max = 25,
     Rounding = 5,
...
Sea:AddSection("Leviathan")
Sea:AddButton({
    Title = "Buy Leviathan Info",
    Description = "NPC: SPY",
    Callback = function()
...
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Kill Leviathan", Default = false })
Toggle:OnChanged(function(state)
...
--------- SETTINGS SKILL -----------
ChooseSkill:AddSection("Sea Events Settings")
...
---------- PREHISTORIC ------------
Sea:AddSection("Prehistoric")
Sea:AddButton({
	Title = "Destroy Lava",
	Description = "Destroy the lava in Prehistoric Island",
	Callback = function()
...
Toggle = Sea:AddToggle("MyToggle", {Title = "Teleport To Prehistoric Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Collect Bone", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Sea:AddToggle("Toggle", {Title = "Auto Collect Egg", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {Title = "Teleport To Ancient Clock", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", { Title = "Teleport To Mirage Island", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {Title = "Auto Trial Race", Description = "Auto Finish Trial Race", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {Title = "Auto Kill Player After Trial", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle = Get:AddToggle("Toggle", {Title = "Auto Buy Legendary Sword", Description = "Buys a legendary sword from the dealer.", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Get:AddToggle("Toggle", {Title = "Auto Skull Guitar [ BETA ]", Default = false})
Toggle:OnChanged(function(Value)
...
Toggle = Get:AddToggle("Toggle", {Title = "Auto CDK", Description = "Get the Cursed Dual Katana", Default = false })
Toggle:OnChanged(function(Value)
...
ImageLabel.Image = "rbxassetid://7791467505"
...
--\\ ♡VIP♡
----------------------------------------------------------------------------------------------------
print("--[[Hop Server if there's an ADMIN!]]--")
local targetPlayers = {
    ["red_game43"] = true,
    ["rip_indra"] = true,
    ["Axiore"] = true,
...
-- Icon: Lucide
-- Kai Scripts | Team!
-- If you want more updates, follow and join to our discord community server!
