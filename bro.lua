...
local autoFarmToggle = farm:AddToggle("autoFarmToggle", {
    Title = "Auto Farm",
    Default = false,
...
local autoStealToggle = farm:AddToggle("autoStealToggle", {
    Title = "Auto Steal",
    Description = "Steals the ball automatically.",
    Default = false,
    Callback = function(Value)
      StealBall = Value
        if Value then
...
local AutoGoal = farm:AddToggle("AutoGoal", {
    Title = "Auto Goal",
...
local autoTPBall = farm:AddToggle("autoTPBall", {
    Title = "Auto TP Ball",
    Description = "Teleports to ball automatically",
    Default = false,
    Callback = function(Value)
...
local autoGoalKeeper = farm:AddToggle("autoGoalKeeper", {
...
local NoCD = farm:AddToggle("NoCD", {
    Title = "No CD",
    Default = false,
    	Callback = function(Value)
		noCDEnabled = Value
...
local AntiAFK = farm:AddToggle("AntiAFK", {
    Title = "Anti AFK",
    Description = "prevents kick due to inactivity.",
    Default = true,
    Callback = function(Value)
